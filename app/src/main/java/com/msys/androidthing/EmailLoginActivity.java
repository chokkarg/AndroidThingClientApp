...
public class EmailLoginActivity extends AppCompatActivity {
    private static final String LOG_TAG = EmailLoginActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    Log.d(EmailLoginActivity.class.getSimpleName(), "onAuthStateChanged:signed_in:" + user.getUid());
                } else {
                    Log.d(EmailLoginActivity.class.getSimpleName(), "onAuthStateChanged:signed_out");
                }
            }
        };
    }
